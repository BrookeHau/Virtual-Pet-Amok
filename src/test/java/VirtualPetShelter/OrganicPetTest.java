...
public class OrganicPetTest {
	 ...
	 private Dog underTest = new Dog("Henry", "dog", 5, 5, 5, 5, 5, 5, 5, 5);
	...
	@Test
	public void getName() {
		VirtualPet underTest = new Dog("Henry", "dog", 5, 5, 5, 5, 5, 5);
	 ...
	 Assert.assertEquals("Henry the dog has hunger of 5, thirst of 5, boredom of
	 5, and bathroom of 5." + "",
	 printString);
	 }
	 ...
	 String printString = underTest.toString();
	 assertThat(printString, is("Henry the dog has hunger of 4, thirst of 5,
	 boredom of 5, and bathroom of 3."));
	 }
